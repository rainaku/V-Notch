...
public static class Loc
{
    ...
    private static void InitializeEnglish()
    {
        _strings["en"] = new Dictionary<string, string>
        {
            ...
            ["settings.performancePreset"] = "Performance Mode",
            ["settings.performancePreset.hint"] = "Choose a preset that maps to animation FPS and heavier visual effects.",
            ["settings.performancePreset.quality"] = "Quality",
            ["settings.performancePreset.balanced"] = "Balanced",
            ["settings.performancePreset.batterySaver"] = "Battery Saver",
            ["settings.performancePreset.custom"] = "Custom",
            ...
            ["settings.enableShadow"] = "Notch shadow",
            ["settings.enableShadow.hint"] = "Draw the notch drop shadow. Disable it to skip the shadow shader pass.",
            ["settings.enableMusicVisualizer"] = "Music visualizer",
            ["settings.enableMusicVisualizer.hint"] = "Show the compact music bars and capture loopback audio for them. Disable it to stop that continuous render path.",
    ...
    private static void InitializeVietnamese()
    {
        _strings["vi"] = new Dictionary<string, string>
        {
            ...
            ["settings.performancePreset"] = "Chế độ hiệu năng",
            ["settings.performancePreset.hint"] = "Chọn preset để tự đặt FPS hoạt ảnh và các hiệu ứng nặng.",
            ["settings.performancePreset.quality"] = "Chất lượng",
            ["settings.performancePreset.balanced"] = "Cân bằng",
            ["settings.performancePreset.batterySaver"] = "Tiết kiệm pin",
            ["settings.performancePreset.custom"] = "Tùy chỉnh",
            ...
            ["settings.enableShadow"] = "Bóng đổ của notch",
            ["settings.enableShadow.hint"] = "Vẽ bóng đổ cho notch. Tắt mục này để bỏ lượt shader bóng đổ.",
            ["settings.enableMusicVisualizer"] = "Music visualizer",
            ["settings.enableMusicVisualizer.hint"] = "Hiện các thanh nhạc ở chế độ compact và thu loopback audio cho chúng. Tắt mục này để dừng đường render liên tục đó.",
